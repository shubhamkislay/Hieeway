...
function signalOtherUser(peerDescp,type) {
        Android.signalOtherUser(peerDescp,type);
    }
...
function createdOffer(description) {
  ...
  peerDescp = description.sdp.toString();
  type = description.type.toString();

  signalOtherUser(peerDescp,type);
...
/*  trace('localPeerConnection setRemoteDescription start.');
  localPeerConnection.setRemoteDescription(description)
    ...
    Android.showToast("created Answer");
}

function readMessage(sdp,type) {
 ...
 //Android.showToast(data.type+" received!");

 answerDes.sdp = sdp;
 answerDes.type = type;

 Android.showToast(answerDes.type+" received!");

/* if (msg.ice != undefined)
 localPeerConnection.addIceCandidate(new RTCIceCandidate(msg.ice));*/

 if (answerDes.type === "offer")
 {
...
/* localPeerConnection.onaddstream = (event =>
 remoteVideo.srcObject = event.stream);*/
    ...
    localPeerConnection.setRemoteDescription(new RTCSessionDescription(answerDes))
      .then(() => {
        setRemoteDescriptionSuccess(localPeerConnection);
      }).catch(setSessionDescriptionError);
