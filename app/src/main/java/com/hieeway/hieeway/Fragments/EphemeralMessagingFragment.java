...
public class EphemeralMessagingFragment extends Fragment implements MessageRunningListener {
    ...
    private String otherUserFeeling;
...
/*        message_counter.setOnClickListener(new View.OnClickListener() {
    ...
    private void filterList(List<ChatMessage> chatMessageList) {
        ...
        try {
            ...
            TaskCompletionSource<List<ChatMessage>> filterListtaskSource = new TaskCompletionSource<>();
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        filterListtaskSource.setResult(sendMessageList);
            ...
            Task<List<ChatMessage>> listTask = filterListtaskSource.getTask();
