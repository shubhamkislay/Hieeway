...
public class SpotifySearchAdapter extends RecyclerView.Adapter<SpotifySearchAdapter.MyViewHolder> {
    ...
    public SpotifySearchAdapter(List<SpotiySearchItem> thumbnailItems, Context context, SpotifyAppRemote spotifyAppRemote, String userPhoto, String useridchattingwith, String username) {
