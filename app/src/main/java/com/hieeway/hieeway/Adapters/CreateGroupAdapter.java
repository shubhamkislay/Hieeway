...
public class CreateGroupAdapter extends RecyclerView.Adapter<CreateGroupAdapter.ViewHolder> {
    ...
    private int totalFriendsSelected = 0;
    private List<Friend> groupMembers;
    private FriendsSelectedListener friendsSelectedListener;


    public CreateGroupAdapter(Context mContext, List<Friend> mUsers, Activity activity, String youtube_Url) {
        ...
        this.friendsSelectedListener = (FriendsSelectedListener) activity;
    }
