...
public class GroupPictureChange extends Dialog {
    ...
    public GroupPictureChange(@NonNull Context context, Boolean active, String imageUrl, ChangePictureListener changePictureListener, String groupID) {
        super(context);
        this.active = active;
