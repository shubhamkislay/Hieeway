...
public class PhotoActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    String messageId,photourl,receiverId,senderId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     databaseReference  = FirebaseDatabase.getInstance()
        ...
        Glide.with(PhotoActivity.this).load(photourl).addListener(new RequestListener<Drawable>() {
            @Override
                ...
                runnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(FirebaseAuth.getInstance().getCurrentUser().getUid().equals(receiverId)) {
                            ...
                            dReference.child(messageId).updateChildren(hashMap);
                        }
        ...
        }).apply(new RequestOptions().override(width, height)).into(view);
